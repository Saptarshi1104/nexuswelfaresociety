...
<head>
	...
	<?php
	    ...
	    echo '<link rel="stylesheet" href="css/home_content.css">';
...
<body>
		...
		<div class="nav">
				...
				<div class="nav-menu">
				        <ul class="nav-list">
						<li class="list-item list-item-selected">Home</li>
	...
	<tr>
		<td colspan="2">
			<div class="welcome-head">Welcome  To Nexus Welfare Society</div>
			<div class="welcome-text">It is totally a non-politaical organisation.To promote sympathy, fellow feeling,unity among the members and to render services for eco-socio development welfare of the common people to achieve quality of lifestyle.</div>
		</td>
	</tr>
    </table>
